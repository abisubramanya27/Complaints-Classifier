...
for i in range(NoT) :
	input_complaint_list.append(speech_part(bucket_name,file_name+"-"+str(i+1)+".mp3"))
...
complaints_labels = tarfile_opener.tarfile_open(path+file_name)
